...
public class tampilkasir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Beliicon1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Beliicon1MouseClicked(evt);
            }
        });
    ...
    private void Beliicon1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Beliicon1MouseClicked
        // halaman login dibuat objek baru
       login halamanLogin = new login();
        //munculin halaman loginnya 
        halamanLogin.setVisible(true);
        // tutup halaman yang aktip
        this.dispose();
       
    }//GEN-LAST:event_Beliicon1MouseClicked
